...
// gettings start with js blowfish
//
// import Blowfish from './assets/js/blowfish'
// const key = 'your key here'
// const data = 'your data here'

// var encrypted = Blowfish.blowfish.encrypt(data, key)
// console.log(encrypted)
// var decrypted = Blowfish.blowfish.decrypt(encrypted, key)
...
(function(global) {
  ...
  crypto.Blowfish = new (function() {
    ...
    function add(x, y) {
      return (
        (((x >> 0x10) + (y >> 0x10) + (((x & 0xffff) + (y & 0xffff)) >> 0x10)) << 0x10) |
