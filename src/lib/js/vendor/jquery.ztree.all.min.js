  ...
  var settings = {},
    ...
    _eventProxy = function(e) {
      ...
      if (
        (tools.eqs(e.type, 'mousedown')
          ...
          ? tools.eqs(t.tagName, 'span') && null !== t.getAttribute('treeNode' + consts.id.SWITCH)
            ? ((o = tools.getNodeMainDom(t).id), (r = 'switchNode'))
            : (l = tools.getMDom(n, t, [{ tagName: 'a', attrName: 'treeNode' + consts.id.A }])) &&
        ...
        switch (((a = data.getNodeCache(n, o)), r)) {
          case 'switchNode':
            ...
            (tools.eqs(e.type, 'click') ||
              (tools.eqs(e.type, 'dblclick') &&
                tools.apply(n.view.dblClickExpand, [n.treeId, a], n.view.dblClickExpand)))
      ...
      return { stop: !1, node: a, nodeEventType: r, nodeEventCallback: i, treeEventType: d, treeEventCallback: s };
    },
    _initNode = function(e, t, n, o, a, r, d) {
      if (n) {
        ...
        tools.isArray(s)
          ...
          : ((l = data.nodeIsParent(e, n, l)), (n.open = !(!l || e.async.enable) && n.open), (n.zAsync = !l)),
          (n.isFirstNode = a),
          (n.isLastNode = r),
    ...
    data = {
      ...
      addNodesData: function(e, t, n, o) {
        ...
        r ? n >= r.length && (n = -1) : ((r = data.nodeChildren(e, t, [])), (n = -1)),
          0 < r.length && 0 === n
            ? ((r[0].isFirstNode = !1), view.setNodeLineIcos(e, r[0]))
            : 0 < r.length && n < 0 && ((r[r.length - 1].isLastNode = !1), view.setNodeLineIcos(e, r[r.length - 1])),
          data.nodeIsParent(e, t, !0),
          n < 0 ? data.nodeChildren(e, t, r.concat(o)) : ((a = [n, 0].concat(o)), r.splice.apply(r, a));
      },
      ...
      getPreNode: function(e, t) {
        if (!t) return null;
        for (
          var n = t.parentTId ? t.getParentNode() : data.getRoot(e), o = data.nodeChildren(e, n), a = 0, r = o.length;
          a < r;
          a++
        )
      ...
      nodeIsParent: function(e, t, n) {
        ...
        return (
          void 0 !== n
            ? ('string' == typeof n && (n = tools.eqs(n, 'true')), (n = !!n), (t[o] = n))
            : 'string' == typeof t[o]
      ...
      removeSelectedNode: function(e, t) {
        for (var n = data.getRoot(e), o = 0, a = n.curSelectedList.length; o < a; o++)
          (t !== n.curSelectedList[o] && data.getNodeCache(e, n.curSelectedList[o].tId)) ||
            (n.curSelectedList.splice(o, 1), e.treeObj.trigger(consts.event.UNSELECTED, [e.treeId, t]), o--, a--);
      },
    ...
    event = {
      ...
      bindTree: function(e) {
        ...
        e.view.txtSelectedEnable ||
          n.bind('selectstart', handler.onSelectStart).css({ '-moz-user-select': '-moz-none' }),
      ...
      proxy: function(e) {
        ...
        for (var n = event.doProxy(e), o = !0, a = 0, r = n.length; a < r; a++) {
          var d = n[a];
          d.nodeEventCallback && (o = d.nodeEventCallback.apply(d, [e, d.node]) && o),
            d.treeEventCallback && (o = d.treeEventCallback.apply(d, [e, d.node]) && o);
        }
        return o;
      },
    },
    handler = {
      ...
      onClickNode: function(e, t) {
        var n = data.getSetting(e.data.treeId),
          o =
            n.view.autoCancelSelected && (e.ctrlKey || e.metaKey) && data.isSelectedNode(n, t)
              ? 0
              : n.view.autoCancelSelected && (e.ctrlKey || e.metaKey) && n.view.selectedMulti
              ? 2
              : 1;
        return (
          0 == tools.apply(n.callback.beforeClick, [n.treeId, t, o], !0) ||
            (0 == o ? view.cancelPreSelectedNode(n, t) : view.selectNode(n, t, 2 == o),
    ...
    tools = {
      ...
      clone: function(e) {
        ...
        for (var n in e)
          t[n] = e[n] instanceof Date ? new Date(e[n].getTime()) : 'object' == typeof e[n] ? tools.clone(e[n]) : e[n];
        return t;
      },
      eqs: function(e, t) {
    ...
    view = {
      addNodes: function(e, t, n, o, a) {
        ...
        if (!e.data.keep.leaf || !t || r)
          if ((tools.isArray(o) || (o = [o]), e.data.simpleData.enable && (o = data.transformTozTreeFormat(e, o)), t)) {
      ...
      appendNodes: function(e, t, n, o, a, r, d) {
        ...
        for (var p = 0, f = n.length; p < f; p++) {
          ...
          h && 0 < h.length && (N = view.appendNodes(e, t + 1, h, g, -1, r, d && g.open)),
            d &&
      ...
      asyncNode: function(setting, node, isSilent, callback) {
        ...
        if (tools.isArray(otherParam))
          for (i = 0, l = otherParam.length; i < l; i += 2) tmpParam[otherParam[i]] = otherParam[i + 1];
      ...
      createNodes: function(e, t, n, o, a) {
        if (n && 0 != n.length) {
          ...
          i && (0 <= a && (s = i.children()[a]), 0 <= a && s ? $(s).before(l.join('')) : i.append(l.join(''))),
      ...
      expandCollapseNode: function(e, t, n, o, a) {
        ...
        if (t) {
          ...
          if (
            ...
            !t.open &&
              s &&
              (!$$(t, consts.id.UL, e).get(0) || (i && 0 < i.length && !$$(i[0], e).get(0))) &&
            ...
            s
              ? ((t.open = !t.open),
                t.iconOpen && t.iconClose && u.attr('style', view.makeNodeIcoStyle(e, t)),
                t.open
        ...
        t &&
          (t.parentTId
            ? (view.expandCollapseNode(e, t, n, o),
              t.parentTId && view.expandCollapseParentNode(e, t.getParentNode(), n, o, a))
      ...
      expandCollapseSonNode: function(e, t, n, o, a) {
        ...
        if (((data.getRoot(e).expandTriggerFlag = !1), d))
          for (var l = 0, c = d.length; l < c; l++) d[l] && view.expandCollapseSonNode(e, d[l], n, i);
      ...
      makeNodeIcoClass: function(e, t) {
        ...
        if (!t.isAjaxing) {
          ...
          (n[0] = (t.iconSkin ? t.iconSkin + '_' : '') + n[0]),
            o ? n.push(t.open ? consts.folder.OPEN : consts.folder.CLOSE) : n.push(consts.folder.DOCU);
        }
      ...
      makeNodeIcoStyle: function(e, t) {
        ...
        if (!t.isAjaxing) {
          ...
          o && n.push('background:url(', o, ') 0 0 no-repeat;'),
            (0 != e.view.showIcon && tools.apply(e.view.showIcon, [e.treeId, t], !0)) || n.push('display:none;');
        }
        return n.join('');
      },
      ...
      removeChildNodes: function(e, t) {
        if (t) {
          ...
          if (n) {
            ...
            if ((data.removeSelectedNode(e), delete t[e.data.key.children], e.data.keep.parent))
      ...
      scrollIntoView: function(e, t) {
        if (t)
          if ('undefined' != typeof Element && 'undefined' != typeof HTMLElement)
            Element.prototype.scrollIntoViewIfNeeded ||
              (Element.prototype.scrollIntoViewIfNeeded = function(n) {
                ...
                for (
                  var r, d = o(this, a(0, 0)), i = a(this.offsetWidth, this.offsetHeight), s = this.parentNode;
                  s instanceof HTMLElement;

                )
                  (r = o(s, a(s.clientLeft, s.clientTop))),
                    (s.scrollLeft = t(e(d.x - r.x, i.x), e(s.scrollLeft, s.clientWidth))),
                    (s.scrollTop = t(e(d.y - r.y, i.y), e(s.scrollTop, s.clientHeight))),
        ...
        if (
          ...
          if (e.data.keep.parent || 0 != c) {
            if (e.view.showLine && 0 < c) {
              var u = a[c - 1];
              if (
                ((i = $$(u, consts.id.UL, e)), (s = $$(u, consts.id.SWITCH, e)), (l = $$(u, consts.id.ICON, e)), o == n)
              )
                if (1 == a.length) view.replaceSwitchClass(u, s, consts.line.ROOT);
                else {
      ...
      setNodeLineIcos: function(e, t) {
        if (t) {
          ...
          0 == r.length ? o.removeClass(consts.line.LINE) : o.addClass(r),
            ...
            data.nodeIsParent(e, t) ? n.removeAttr('disabled') : n.attr('disabled', 'disabled'),
            a.removeAttr('style'),
      ...
      setNodeName: function(e, t) {
        ...
        o.empty(),
          e.view.nameIsHTML ? o.html(data.nodeName(e, t)) : o.text(data.nodeName(e, t)),
    ...
    init: function(e, t, n) {
      ...
      var r = {
        ...
        expandNode: function(t, e, n, o, a) {
          return t && data.nodeIsParent(s, t)
            ? (!0 !== e && !1 !== e && (e = !t.open),
              ((a = !!a) && e && 0 == tools.apply(s.callback.beforeExpand, [s.treeId, t], !0)) ||
              (a && !e && 0 == tools.apply(s.callback.beforeCollapse, [s.treeId, t], !0))
                ? null
                : (e && t.parentTId && view.expandCollapseParentNode(s, t.getParentNode(), e, !1),
                  e !== t.open || n
                    ? ((data.getRoot(s).expandTriggerFlag = a),
                      !tools.canAsync(s, t) && n
                        ? view.expandCollapseSonNode(s, t, e, !0, r)
                        : ((t.open = !e), view.switchNode(this.setting, t), r()),
                      e)
                    : null))
            : null;
          function r() {
        ...
        getNodesByFilter: function(e, t, n, o) {
          return (
            (t = !!t),
            e && 'function' == typeof e
              ? data.getNodesByFilter(s, n ? data.nodeChildren(s, n) : data.getNodes(s), e, t, o)
              : t
              ? null
              : []
          );
        ...
        getNodeIndex: function(e) {
          if (!e) return null;
          for (
            var t = e.parentTId ? e.getParentNode() : data.getRoot(s), n = data.nodeChildren(s, t), o = 0, a = n.length;
            o < a;
            o++
          )
            if (n[o] == e) return o;
        ...
        reAsyncChildNodes: function(e, t, n, o) {
          if (this.setting.async.enable) {
            ...
            if ((a && (e = data.getRoot(s)), 'refresh' == t)) {
              ...
              if ((data.removeSelectedNode(s), data.nodeChildren(s, e, []), a)) this.setting.treeObj.empty();
        ...
        removeNode: function(e, t) {
          e &&
            (((t = !!t) && 0 == tools.apply(s.callback.beforeRemove, [s.treeId, e], !0)) ||
              (view.removeNode(s, e), t && this.setting.treeObj.trigger(consts.event.REMOVE, [s.treeId, e])));
        },
        selectNode: function(t, e, n) {
          if (t && tools.uCanDo(s)) {
            if (((e = s.view.selectedMulti && e), t.parentTId))
              view.expandCollapseParentNode(s, t.getParentNode(), !0, !1, function() {
                if (n) return;
                var e = $$(t, s).get(0);
      ...
      return (
        a && 0 < a.length
          ...
          : s.async.enable && s.async.url && '' !== s.async.url && view.asyncNode(s),
        r
      );
    },
  };
...
!(function(e) {
  var t = {
    ...
    r = {
      onCheckNode: function(e, t) {
        ...
        return (
          l.setChkClass(c, a, t),
          l.repairParentChkClassWithSelf(c, t),
          c.treeObj.trigger(s.event.CHECK, [e, c.treeId, t]),
          !0
        );
      },
      ...
      view: {
        checkNodeRelation: function(e, t) {
          ...
          if (e.check.chkStyle == n.STYLE) {
              ...
              if (e.check.radioType == n.TYPE_ALL) {
                for (h = r.length - 1; 0 <= h; h--) {
                  (c = r[h]),
                    C.nodeChecked(e, c) &&
                      ...
                      (C.nodeChecked(e, c, !1),
                      r.splice(h, 1),
                      l.setChkClass(e, f(c, s.id.CHECK, e), c),
                      c.parentTId != t.parentTId && l.repairParentChkClassWithSelf(e, c));
                }
                r.push(t);
              } else {
                ...
                for (h = 0, a = (d = C.nodeChildren(e, o)).length; h < a; h++) {
                  (c = d[h]),
                    C.nodeChecked(e, c) &&
                      c != t &&
                      (C.nodeChecked(e, c, !1), l.setChkClass(e, f(c, s.id.CHECK, e), c));
                }
              }
            else if (e.check.radioType == n.TYPE_ALL)
              for (h = 0, a = r.length; h < a; h++)
                if (t == r[h]) {
                  r.splice(h, 1);
                  break;
                }
            ...
            i && (!d || 0 == d.length || -1 < e.check.chkboxType.Y.indexOf('s')) && l.setSonNodeCheckBox(e, t, !0),
              i || (d && 0 != d.length && !(-1 < e.check.chkboxType.N.indexOf('s'))) || l.setSonNodeCheckBox(e, t, !1),
              i && -1 < e.check.chkboxType.Y.indexOf('p') && l.setParentNodeCheckBox(e, t, !0),
              !i && -1 < e.check.chkboxType.N.indexOf('p') && l.setParentNodeCheckBox(e, t, !1);
          }
        },
        makeChkClass: function(e, t) {
          ...
          a =
            !0 === t.chkDisabled
              ...
              : t.halfCheck
              ? c.PART
              : e.check.chkStyle == h.STYLE
              ? t.check_Child_State < 1
                ? c.FULL
                : c.PART
              : n
              ? 2 === t.check_Child_State || -1 === t.check_Child_State
                ? c.FULL
                : c.PART
              : t.check_Child_State < 1
              ? c.FULL
          ...
          return (
            (i = t.check_Focus && !0 !== t.chkDisabled ? i + '_' + c.FOCUS : i),
            s.className.BUTTON + ' ' + c.DEFAULT + ' ' + i
          );
        },
        repairAllChk: function(e, t) {
          if (e.check.enable && e.check.chkStyle === s.checkbox.STYLE)
            for (var c = C.getRoot(e), h = C.nodeChildren(e, c), a = 0, n = h.length; a < n; a++) {
              var i = h[a];
        ...
        repairSonChkDisabled: function(e, t, c, h) {
          if (t) {
        ...
        repairParentChkDisabled: function(e, t, c, h) {
          t &&
            (t.chkDisabled != c && h && (t.chkDisabled = c),
            l.repairChkClass(e, t),
            l.repairParentChkDisabled(e, t.getParentNode(), c, h));
        },
        setChkClass: function(e, t, c) {
          t && (!0 === c.nocheck ? t.hide() : t.show(), t.attr('class', l.makeChkClass(e, c)));
        },
        setParentNodeCheckBox: function(e, t, c, h) {
          ...
          if (
            ...
            !0 !== t.nocheck &&
              ...
              (C.nodeChecked(e, t, c),
              l.setChkClass(e, a, t),
              e.check.autoCheckTrigger && t != h && e.treeObj.trigger(s.event.CHECK, [null, e.treeId, t])),
            t.parentTId)
          ) {
            var n = !0;
            if (!c)
              for (var i = C.nodeChildren(e, t.getParentNode()), r = 0, o = i.length; r < o; r++) {
                var d = i[r],
                  k = C.nodeChecked(e, d);
                if (
                  (!0 !== d.nocheck && !0 !== d.chkDisabled && k) ||
                  ((!0 === d.nocheck || !0 === d.chkDisabled) && 0 < d.check_Child_State)
                ) {
                  n = !1;
                  break;
                }
        ...
        setSonNodeCheckBox: function(e, t, c, h) {
          if (t) {
            var a = f(t, s.id.CHECK, e);
            h = h || t;
            var n = !1,
            ...
            t != C.getRoot(e) &&
              !0 !== t.chkDisabled &&
              (n && !0 !== t.nocheck && C.makeChkFlag(e, t),
              !0 !== t.nocheck && !0 !== t.chkDisabled
                ? (C.nodeChecked(e, t, c), n || (t.check_Child_State = i && 0 < i.length ? (c ? 2 : 0) : -1))
                : (t.check_Child_State = -1),
              l.setChkClass(e, a, t),
              e.check.autoCheckTrigger &&
                t != h &&
                !0 !== t.nocheck &&
                !0 !== t.chkDisabled &&
                e.treeObj.trigger(s.event.CHECK, [null, e.treeId, t]));
          }
        },
      },
      event: {},
      data: {
        ...
        getCheckStatus: function(e, t) {
          ...
          return {
            ...
            half: t.halfCheck
              ? t.halfCheck
              : e.check.chkStyle == s.radio.STYLE
              ? 2 === t.check_Child_State
              : c
              ? -1 < t.check_Child_State && t.check_Child_State < 2
              : 0 < t.check_Child_State,
          };
        },
        getTreeCheckedNodes: function(e, t, c, h) {
          if (!t) return [];
        ...
        getTreeChangeCheckedNodes: function(e, t, c) {
          if (!t) return [];
          c = c || [];
          for (var h = 0, a = t.length; h < a; h++) {
            var n = t[h],
              ...
              r = C.nodeChecked(e, n);
            !0 !== n.nocheck && !0 !== n.chkDisabled && r != n.checkedOld && c.push(n),
              C.getTreeChangeCheckedNodes(e, i, c);
          }
          return c;
        },
              ...
              for (var a = 0, n = h.length; a < n; a++) {
                ...
                if (e.check.chkStyle == s.radio.STYLE) {
                  if (
                    2 ==
                    (o =
                      !0 === i.nocheck || !0 === i.chkDisabled
                        ? i.check_Child_State
                        : !0 === i.halfCheck || r || 0 < i.check_Child_State
                        ? 2
                        : 0)
                  ) {
                    c = 2;
                  ...
                  if (
                    ...
                    (o =
                      !0 === i.nocheck || !0 === i.chkDisabled
                        ...
                        ? 1
                        : r
                        ? -1 === i.check_Child_State || 2 === i.check_Child_State
                          ? 2
                          : 1
                        : 0 < i.check_Child_State
                        ? 1
                        : 0)
                  ) {
                    c = 1;
  ...
  (C.nodeChecked = function(e, t, c) {
    ...
    return (
      void 0 !== c
        ? ('string' == typeof c && (c = o.eqs(c, 'true')), (c = !!c), (t[h] = c))
        : 'string' == typeof t[h]
        ? (t[h] = o.eqs(t[h], 'true'))
        : (t[h] = !!t[h]),
      t[h]
    ...
    C.addInitCache(function(e) {}),
    C.addInitNode(function(e, t, c, h, a, n, i) {
      if (c) {
        var r = C.nodeChecked(e, c);
        if (
          ((c.checkedOld = r),
          'string' == typeof c.nocheck && (c.nocheck = o.eqs(c.nocheck, 'true')),
          (c.nocheck = !!c.nocheck || (e.check.nocheckInherit && h && !!h.nocheck)),
          'string' == typeof c.chkDisabled && (c.chkDisabled = o.eqs(c.chkDisabled, 'true')),
          (c.chkDisabled = !!c.chkDisabled || (e.check.chkDisabledInherit && h && !!h.chkDisabled)),
          'string' == typeof c.halfCheck && (c.halfCheck = o.eqs(c.halfCheck, 'true')),
          ...
          e.check.chkStyle == s.radio.STYLE && e.check.radioType == s.radio.TYPE_ALL && r)
        )
          C.getRoot(e).radioCheckedList.push(c);
      }
    }),
    C.addInitProxy(function(e) {
      var t = e.target,
        ...
        i = null;
      if (
        (o.eqs(e.type, 'mouseover')
          ? c.check.enable &&
            o.eqs(t.tagName, 'span') &&
            null !== t.getAttribute('treeNode' + s.id.CHECK) &&
            ((h = o.getNodeMainDom(t).id), (n = 'mouseoverCheck'))
          : o.eqs(e.type, 'mouseout')
          ? c.check.enable &&
            o.eqs(t.tagName, 'span') &&
            null !== t.getAttribute('treeNode' + s.id.CHECK) &&
            ((h = o.getNodeMainDom(t).id), (n = 'mouseoutCheck'))
          : o.eqs(e.type, 'click') &&
            c.check.enable &&
            o.eqs(t.tagName, 'span') &&
            null !== t.getAttribute('treeNode' + s.id.CHECK) &&
            ((h = o.getNodeMainDom(t).id), (n = 'checkNode')),
        0 < h.length)
      )
        switch (((a = C.getNodeCache(c, h)), n)) {
          case 'checkNode':
            i = r.onCheckNode;
            break;
          case 'mouseoverCheck':
    ...
    C.addBeforeA(function(e, t, c) {
      e.check.enable &&
        ...
        c.push(
          ...
          "' treeNode",
          s.id.CHECK,
          !0 === t.nocheck ? " style='display:none;'" : '',
          '></span>',
        ));
    }),
    C.addZTreeTools(function(i, h) {
      (h.checkNode = function(e, t, c, h) {
        ...
        if (
          ...
          (h = !!h),
          (a !== t || c) &&
            (!h || 0 != o.apply(this.setting.callback.beforeCheck, [this.setting.treeId, e], !0)) &&
            o.uCanDo(this.setting) &&
            this.setting.check.enable &&
            !0 !== e.nocheck)
        ) {
          C.nodeChecked(i, e, t);
          var n = f(e, s.id.CHECK, this.setting);
          (!c && this.setting.check.chkStyle !== s.radio.STYLE) || l.checkNodeRelation(this.setting, e),
            l.setChkClass(this.setting, n, e),
            l.repairParentChkClassWithSelf(this.setting, e),
            h && this.setting.treeObj.trigger(s.event.CHECK, [null, this.setting.treeId, e]);
        }
      }),
        ...
        (h.setChkDisabled = function(e, t, c, h) {
          (t = !!t),
            (c = !!c),
            (h = !!h),
            l.repairSonChkDisabled(this.setting, e, t, h),
            l.repairParentChkDisabled(this.setting, e.getParentNode(), t, c);
        });
      var a = h.updateNode;
      h.updateNode = function(e, t) {
        if (
          (a && a.apply(h, arguments), e && this.setting.check.enable) &&
          f(e, this.setting).get(0) &&
          o.uCanDo(this.setting)
        ) {
          var c = f(e, s.id.CHECK, this.setting);
          (1 != t && this.setting.check.chkStyle !== s.radio.STYLE) || l.checkNodeRelation(this.setting, e),
            l.setChkClass(this.setting, c, e),
            l.repairParentChkClassWithSelf(this.setting, e);
        }
      };
    });
...
!(function(fe) {
    ...
    s = {
      ...
      onHoverOutNode: function(e, t) {
        var o = Re.getSetting(e.data.treeId),
          d = Re.getRoot(o);
        d.curHoverNode &&
          !Re.isSelectedNode(o, d.curHoverNode) &&
          (be.removeTreeDom(o, d.curHoverNode), (d.curHoverNode = null));
      },
      onMousedownNode: function(e, t) {
        ...
        var r = e.target,
          ...
          ee = [];
        if (Re.isSelectedNode(Z, t))
          for (o = 0, d = n.length; o < d; o++) {
            if (n[o].editNameFlag && Ie.eqs(r.tagName, 'input') && null !== r.getAttribute('treeNode' + he.id.INPUT))
              return !0;
        ...
        function s(e) {
          if (
            0 == $.dragFlag &&
            Math.abs(ve - e.clientX) < Z.edit.drag.minMoveSize &&
            Math.abs(me - e.clientY) < Z.edit.drag.minMoveSize
          )
            return !0;
          var t, o, d, r, n;
          if ((ie.css('cursor', 'pointer'), 0 == $.dragFlag)) {
            ...
            for (t = 0, o = ee.length; t < o; t++)
              0 == t && ($.dragNodeShowBefore = []),
                (d = ee[t]),
                Re.nodeIsParent(Z, d) && d.open
                  ? (be.expandCollapseNode(Z, d, !d.open), ($.dragNodeShowBefore[d.tId] = !0))
                  : ($.dragNodeShowBefore[d.tId] = !1);
            ($.dragFlag = 1), (J.showHoverDom = !1), Ie.showIfameMask(Z, !0);
            var a = !0,
              i = -1;
            if (1 < ee.length) {
              var l = ee[0].parentTId ? Re.nodeChildren(Z, ee[0].getParentNode()) : Re.getNodes(Z);
              for (n = [], t = 0, o = l.length; t < o; t++)
                if (
                  (void 0 !== $.dragNodeShowBefore[l[t].tId] &&
                    (a && -1 < i && i + 1 !== t && (a = !1), n.push(l[t]), (i = t)),
                  ee.length === n.length)
                ) {
                  ee = n;
                  break;
            ...
            for (
              a && ((re = ee[0].getPreNode()), (ne = ee[ee.length - 1].getNextNode())),
                te = Pe("<ul class='zTreeDragUL'></ul>", Z),
                t = 0,
                o = ee.length;
              t < o;
              t++
            )
              ((d = ee[t]).editNameFlag = !1),
                be.selectNode(Z, d, 0 < t),
                be.removeTreeDom(Z, d),
                t > Z.edit.drag.maxShowNodeNum - 1 ||
                  ((r = Pe("<li id='" + d.tId + "_tmp'></li>", Z)).append(Pe(d, he.id.A, Z).clone()),
                  r.css('padding', '0'),
                  r.children('#' + d.tId + he.id.A).removeClass(he.node.CURSELECTED),
                  te.append(r),
                  t == Z.edit.drag.maxShowNodeNum - 1 &&
                    ((r = Pe("<li id='" + d.tId + "_moretmp'><a>  ...  </a></li>", Z)), te.append(r)));
            te.attr('id', ee[0].tId + he.id.UL + '_tmp'),
              te.addClass(Z.treeObj.attr('class')),
              te.appendTo(ie),
              (oe = Pe("<span class='tmpzTreeMove_arrow'></span>", Z)).attr('id', 'zTreeMove_arrow_tmp'),
              oe.appendTo(ie),
              Z.treeObj.trigger(he.event.DRAG, [e, Z.treeId, ee]);
          }
          if (1 == $.dragFlag) {
            if (
              de &&
              oe.attr('id') == e.target.id &&
              ue &&
              e.clientX + ae.scrollLeft() + 2 > fe('#' + ue + he.id.A, de).offset().left
            ) {
              var s = fe('#' + ue + he.id.A, de);
              e.target = 0 < s.length ? s.get(0) : e.target;
            } else
              de &&
                (de.removeClass(he.node.TMPTARGET_TREE),
                ue &&
                  fe('#' + ue + he.id.A, de)
                    .removeClass(he.node.TMPTARGET_NODE + '_' + he.move.TYPE_PREV)
                    .removeClass(he.node.TMPTARGET_NODE + '_' + Ee.move.TYPE_NEXT)
                    .removeClass(he.node.TMPTARGET_NODE + '_' + Ee.move.TYPE_INNER));
            ...
            for (var N in c)
              c[N].treeId &&
                c[N].edit.enable &&
                c[N].treeId != Z.treeId &&
                (e.target.id == c[N].treeId || 0 < fe(e.target).parents('#' + c[N].treeId).length) &&
                ((le = !0), (se = c[N]));
            var u = ae.scrollTop(),
              g = ae.scrollLeft(),
              v = se.treeObj.offset(),
              ...
              T = e.clientY + u - v.top,
              f = se.treeObj.height() + v.top - e.clientY - u,
              E = e.clientX + g - v.left,
              I = se.treeObj.width() + v.left - e.clientX - g,
              ...
              C =
                T > Z.edit.drag.borderMin &&
                f > Z.edit.drag.borderMin &&
                E > Z.edit.drag.borderMin &&
                I > Z.edit.drag.borderMin,
            ...
            if (e.target && Ie.isChildOrSelf(e.target, se.treeId)) {
              for (var D = e.target; D && D.tagName && !Ie.eqs(D.tagName, 'li') && D.id != se.treeId; )
                D = D.parentNode;
              var y = !0;
              for (t = 0, o = ee.length; t < o; t++) {
            ...
            (d = ee[0]),
              C &&
                Ie.isChildOrSelf(e.target, se.treeId) &&
                (!de &&
                  (e.target.id == se.treeId || w || M || _ || O) &&
                  (le || (!le && d.parentTId)) &&
                  (de = se.treeObj),
                h
                  ? se.treeObj.scrollTop(se.treeObj.scrollTop() - 10)
                  : b && se.treeObj.scrollTop(se.treeObj.scrollTop() + 10),
                R
                  ? se.treeObj.scrollLeft(se.treeObj.scrollLeft() - 10)
                  : P && se.treeObj.scrollLeft(se.treeObj.scrollLeft() + 10),
                de &&
                  de != se.treeObj &&
                  de.offset().left < se.treeObj.offset().left &&
                  se.treeObj.scrollLeft(se.treeObj.scrollLeft() + de.offset().left - se.treeObj.offset().left)),
              te.css({ top: e.clientY + u + 3 + 'px', left: e.clientX + g + 3 + 'px' });
            var k = 0,
              S = 0;
            if (de && de.attr('id') != se.treeId) {
              var A = null == ue ? null : Re.getNodeCache(se, ue),
                L =
                  ((e.ctrlKey || e.metaKey) && Z.edit.drag.isMove && Z.edit.drag.isCopy) ||
                  (!Z.edit.drag.isMove && Z.edit.drag.isCopy),
                Y = !(!re || ue !== re.tId),
                x = !(!ne || ue !== ne.tId),
                j = d.parentTId && d.parentTId == ue,
                z = (L || !x) && Ie.apply(se.edit.drag.prev, [se.treeId, ee, A], !!se.edit.drag.prev),
                B = (L || !Y) && Ie.apply(se.edit.drag.next, [se.treeId, ee, A], !!se.edit.drag.next),
                H =
                  (L || !j) &&
                  !(se.data.keep.leaf && !Re.nodeIsParent(Z, A)) &&
                  Ie.apply(se.edit.drag.inner, [se.treeId, ee, A], !!se.edit.drag.inner);
              function F() {
                (de = null),
                  (ue = ''),
                  (ge = he.move.TYPE_INNER),
              ...
              if (z || B || H) {
                var V = fe('#' + ue + he.id.A, de),
                  U = A.isLastNode ? null : fe('#' + A.getNextNode().tId + he.id.A, de.next()),
                  G = V.offset().top,
                  X = V.offset().left,
                  q = z ? (H ? 0.25 : B ? 0.5 : 1) : -1,
                  W = B ? (H ? 0.75 : z ? 0.5 : 0) : -1,
                  K = (e.clientY + u - G) / V.height();
                if (
                  ((1 == q || (K <= q && -0.2 <= K)) && z
                    ? ((k = 1 - oe.width()), (S = G - oe.height() / 2), (ge = he.move.TYPE_PREV))
                    : (0 == W || (W <= K && K <= 1.2)) && B
                    ? ((k = 1 - oe.width()),
                      (S =
                        null == U || (Re.nodeIsParent(Z, A) && A.open)
                          ? G + V.height() - oe.height() / 2
                          : U.offset().top - oe.height() / 2),
                      (ge = he.move.TYPE_NEXT))
                    : H
                    ? ((k = 5 - oe.width()), (S = G), (ge = he.move.TYPE_INNER))
                    : F(),
                  de &&
                    (oe.css({ display: 'block', top: S + 'px', left: X + k + 'px' }),
                    V.addClass(he.node.TMPTARGET_NODE + '_' + ge),
                    (ce == ue && Ne == ge) || (pe = new Date().getTime()),
                    A && Re.nodeIsParent(Z, A) && ge == he.move.TYPE_INNER))
                ) {
                  var Q = !0;
                  window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId !== A.tId
                    ? (clearTimeout(window.zTreeMoveTimer), (window.zTreeMoveTargetNodeTId = null))
                    : window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId === A.tId && (Q = !1),
                    Q &&
                      ((window.zTreeMoveTimer = setTimeout(function() {
                        ge == he.move.TYPE_INNER &&
                          ...
                          Re.nodeIsParent(Z, A) &&
                          !A.open &&
                          new Date().getTime() - pe > se.edit.drag.autoOpenTime &&
                          Ie.apply(se.callback.beforeDragOpen, [se.treeId, A], !0) &&
                          (be.switchNode(se, A),
                          se.edit.drag.autoExpandTrigger && se.treeObj.trigger(he.event.EXPAND, [se.treeId, A]));
                      }, se.edit.drag.autoOpenTime + 50)),
                      (window.zTreeMoveTargetNodeTId = A.tId));
                }
              } else F();
            } else
              (ge = he.move.TYPE_INNER),
                de && Ie.apply(se.edit.drag.inner, [se.treeId, ee, null], !!se.edit.drag.inner)
                  ? de.addClass(he.node.TMPTARGET_TREE)
                  : (de = null),
                oe.css({ display: 'none' }),
                window.zTreeMoveTimer && (clearTimeout(window.zTreeMoveTimer), (window.zTreeMoveTargetNodeTId = null));
            (ce = ue), (Ne = ge), Z.treeObj.trigger(he.event.DRAGMOVE, [e, Z.treeId, ee]);
          }
          return !1;
        }
        function Te(d) {
          if (
            (window.zTreeMoveTimer && (clearTimeout(window.zTreeMoveTimer), (window.zTreeMoveTargetNodeTId = null)),
            (Ne = ce = null),
            ae.unbind('mousemove', s),
            ae.unbind('mouseup', Te),
            ae.unbind('selectstart', c),
            ie.css('cursor', ''),
            de &&
              (de.removeClass(he.node.TMPTARGET_TREE),
              ue &&
                fe('#' + ue + he.id.A, de)
                  ...
                  .removeClass(he.node.TMPTARGET_NODE + '_' + Ee.move.TYPE_NEXT)
                  .removeClass(he.node.TMPTARGET_NODE + '_' + Ee.move.TYPE_INNER)),
            Ie.showIfameMask(Z, !1),
            (J.showHoverDom = !0),
            0 != $.dragFlag)
          ) {
            var e, t, o;
            for (e = $.dragFlag = 0, t = ee.length; e < t; e++)
              (o = ee[e]),
                Re.nodeIsParent(Z, o) &&
                  $.dragNodeShowBefore[o.tId] &&
                  !o.open &&
                  (be.expandCollapseNode(Z, o, !o.open), delete $.dragNodeShowBefore[o.tId]);
            te && te.remove(), oe && oe.remove();
            var r =
              ((d.ctrlKey || d.metaKey) && Z.edit.drag.isMove && Z.edit.drag.isCopy) ||
              (!Z.edit.drag.isMove && Z.edit.drag.isCopy);
            if (
              (!r && de && ue && ee[0].parentTId && ue == ee[0].parentTId && ge == he.move.TYPE_INNER && (de = null),
              de)
            ) {
              var n = null == ue ? null : Re.getNodeCache(se, ue);
              if (0 == Ie.apply(Z.callback.beforeDrop, [se.treeId, ee, n, ge, r], !0))
                return void be.selectNodes(l, ee);
              var a = r ? Ie.clone(ee) : ee;
              function i() {
                if (le) {
                  if (!r) for (var e = 0, t = ee.length; e < t; e++) be.removeNode(Z, ee[e]);
                  ge == he.move.TYPE_INNER
                    ? be.addNodes(se, n, -1, a)
                    : be.addNodes(se, n.getParentNode(), ge == he.move.TYPE_PREV ? n.getIndex() : n.getIndex() + 1, a);
                } else if (r && ge == he.move.TYPE_INNER) be.addNodes(se, n, -1, a);
                else if (r)
                  be.addNodes(se, n.getParentNode(), ge == he.move.TYPE_PREV ? n.getIndex() : n.getIndex() + 1, a);
                else if (ge != he.move.TYPE_NEXT)
                  for (e = 0, t = a.length; e < t; e++) be.moveNode(se, n, a[e], ge, !1);
                else for (e = -1, t = a.length - 1; e < t; t--) be.moveNode(se, n, a[t], ge, !1);
                be.selectNodes(se, a);
                var o = Pe(a[0], Z).get(0);
                be.scrollIntoView(Z, o), Z.treeObj.trigger(he.event.DROP, [d, se.treeId, a, n, ge, r]);
              }
              ge == he.move.TYPE_INNER && Ie.canAsync(se, n) ? be.asyncNode(se, n, !1, i) : i();
    ...
    e = {
      tools: {
        ...
        showIfameMask: function(e, t) {
          ...
          if (t)
            for (var d = Pe('iframe', e), r = 0, n = d.length; r < n; r++) {
              var a = d.get(r),
                i = Ie.getAbs(a),
                l = Pe(
                  "<div id='zTreeMask_" +
      ...
      view: {
        addEditBtn: function(e, t) {
          if (
            !(t.editNameFlag || 0 < Pe(t, he.id.EDIT, e).length) &&
            Ie.apply(e.edit.showRenameBtn, [e.treeId, t], e.edit.showRenameBtn)
          ) {
            var o = Pe(t, he.id.A, e),
              d =
                ...
                he.id.EDIT +
                "' title='" +
                Ie.apply(e.edit.renameTitle, [e.treeId, t], e.edit.renameTitle) +
                "' treeNode" +
                he.id.EDIT +
            ...
            o.append(d),
              Pe(t, he.id.EDIT, e)
                .bind('click', function() {
                  return (
                    Ie.uCanDo(e) && 0 != Ie.apply(e.callback.beforeEditName, [e.treeId, t], !0) && be.editNode(e, t), !1
                  );
                })
                .show();
          }
        ...
        addRemoveBtn: function(e, t) {
          if (
            !(t.editNameFlag || 0 < Pe(t, he.id.REMOVE, e).length) &&
            Ie.apply(e.edit.showRemoveBtn, [e.treeId, t], e.edit.showRemoveBtn)
          ) {
            var o = Pe(t, he.id.A, e),
              d =
                "<span class='" +
                ...
                he.id.REMOVE +
                "' title='" +
                Ie.apply(e.edit.removeTitle, [e.treeId, t], e.edit.removeTitle) +
                "' treeNode" +
                he.id.REMOVE +
                " style='display:none;'></span>";
            o.append(d),
              Pe(t, he.id.REMOVE, e)
                .bind('click', function() {
                  return (
                    Ie.uCanDo(e) &&
                      0 != Ie.apply(e.callback.beforeRemove, [e.treeId, t], !0) &&
                      (be.removeNode(e, t), e.treeObj.trigger(he.event.REMOVE, [e.treeId, t])),
                    !1
                  );
                })
        ...
        addHoverDom: function(e, t) {
          Re.getRoots().showHoverDom &&
            ((t.isHover = !0),
            e.edit.enable && (be.addEditBtn(e, t), be.addRemoveBtn(e, t)),
            Ie.apply(e.view.addHoverDom, [e.treeId, t]));
        },
        cancelCurEditNode: function(e, t, o) {
          var d = Re.getRoot(e),
            r = d.curEditNode;
          if (r) {
            ...
            Re.nodeName(e, r, a),
              Pe(r, he.id.A, e).removeClass(he.node.CURSELECTED_EDIT),
              n.unbind(),
              be.setNodeName(e, r),
              (r.editNameFlag = !1),
              (d.curEditNode = null),
              (d.curEditInput = null),
              be.selectNode(e, r, !1),
              e.treeObj.trigger(he.event.RENAME, [e.treeId, r, o]);
          }
          return (d.noSelection = !0);
        },
        editNode: function(t, e) {
          var o = Re.getRoot(t);
          if (((be.editNodeBlur = !1), Re.isSelectedNode(t, e) && o.curEditNode == e && e.editNameFlag))
            setTimeout(function() {
              Ie.inputFocus(o.curEditInput);
            }, 0);
          else {
            (e.editNameFlag = !0),
              be.removeTreeDom(t, e),
              be.cancelCurEditNode(t),
              be.selectNode(t, e, !1),
              Pe(e, he.id.SPAN, t).html(
                "<input type=text class='rename' id='" + e.tId + he.id.INPUT + "' treeNode" + he.id.INPUT + ' >',
              );
            var d = Pe(e, he.id.INPUT, t);
            d.attr('value', Re.nodeName(t, e)),
              t.edit.editNameSelectAll ? Ie.inputSelect(d) : Ie.inputFocus(d),
              d
                ...
                .bind('keydown', function(e) {
                  '13' == e.keyCode
                    ? ((be.editNodeBlur = !0), be.cancelCurEditNode(t))
                    : '27' == e.keyCode && be.cancelCurEditNode(t, null, !0);
                })
              ...
              Pe(e, he.id.A, t).addClass(he.node.CURSELECTED_EDIT),
              (o.curEditInput = d),
              (o.noSelection = !1),
              (o.curEditNode = e);
          }
        },
        moveNode: function(e, t, o, d, r, n) {
          var a = Re.getRoot(e);
          if (t != o && (!e.data.keep.leaf || !t || Re.nodeIsParent(e, t) || d != he.move.TYPE_INNER)) {
            ...
            if (
              (d != he.move.TYPE_PREV && d != he.move.TYPE_NEXT && (d = he.move.TYPE_INNER),
              d == he.move.TYPE_INNER &&
                (l
                  ? (o.parentTId = null)
                  : (Re.nodeIsParent(e, t) ||
                      (Re.nodeIsParent(e, t, !0), (t.open = !!t.open), be.setNodeLineIcos(e, t)),
                    (o.parentTId = t.tId))),
              l)
            )
              c = s = e.treeObj;
              ...
              if (
                (n || d != he.move.TYPE_INNER
                  ? n || be.expandCollapseNode(e, t.getParentNode(), !0, !1)
                  : be.expandCollapseNode(e, t, !0, !1),
                (s = Pe(t, e)),
                (c = Pe(t, he.id.UL, e)),
                s.get(0) && !c.get(0))
              ) {
            ...
            var g = Pe(o, e);
            g.get(0) ? s.get(0) || g.remove() : (g = be.appendNodes(e, o.level, [o], null, -1, !1, !0).join('')),
              c.get(0) && d == he.move.TYPE_INNER
                ? c.append(g)
                : s.get(0) && d == he.move.TYPE_PREV
                ? s.before(g)
                : s.get(0) && d == he.move.TYPE_NEXT && s.after(g);
            var v,
              m,
              p = -1,
              T = 0,
            ...
            if (o.isFirstNode) (p = 0), 1 < h.length && ((f = h[1]).isFirstNode = !0);
            else if (o.isLastNode) (f = h[(p = h.length - 1) - 1]).isLastNode = !0;
            else
            ...
            if ((0 <= p && h.splice(p, 1), d != he.move.TYPE_INNER))
              for (v = 0, m = b.length; v < m; v++) b[v].tId == t.tId && (T = v);
            if (
              (d == he.move.TYPE_INNER
                ? (0 < (R = R || Re.nodeChildren(e, t, [])).length && ((E = R[R.length - 1]).isLastNode = !1),
                  R.splice(R.length, 0, o),
                  (o.isLastNode = !0),
                  (o.isFirstNode = 1 == R.length))
                : t.isFirstNode && d == he.move.TYPE_PREV
                ? (b.splice(T, 0, o),
                  ((E = t).isFirstNode = !1),
                  (o.parentTId = t.parentTId),
                  (o.isFirstNode = !0),
                  (o.isLastNode = !1))
                : t.isLastNode && d == he.move.TYPE_NEXT
                ? (b.splice(T + 1, 0, o),
                  ((E = t).isLastNode = !1),
                  (o.parentTId = t.parentTId),
                  (o.isFirstNode = !1),
                  (o.isLastNode = !0))
                : (d == he.move.TYPE_PREV ? b.splice(T, 0, o) : b.splice(T + 1, 0, o),
                  (o.parentTId = t.parentTId),
                  (o.isFirstNode = !1),
                  (o.isLastNode = !1)),
              Re.fixPIdKeyValue(e, o),
              Re.setSonNodeLevel(e, o.getParentNode(), o),
              be.setNodeLineIcos(e, o),
              be.repairNodeLevelClass(e, o, I),
              !e.data.keep.parent && h.length < 1)
            ) {
              Re.nodeIsParent(e, i, !1), (i.open = !1);
              var P = Pe(i, he.id.UL, e),
                C = Pe(i, he.id.SWITCH, e),
                w = Pe(i, he.id.ICON, e);
              be.replaceSwitchClass(i, C, he.folder.DOCU),
                be.replaceIcoClass(i, w, he.folder.DOCU),
                P.css('display', 'none');
            } else f && be.setNodeLineIcos(e, f);
            E && be.setNodeLineIcos(e, E),
              e.check &&
                e.check.enable &&
                be.repairChkClass &&
                (be.repairChkClass(e, i),
                be.repairParentChkClassWithSelf(e, i),
                i != o.parent && be.repairParentChkClassWithSelf(e, o)),
              n || be.expandCollapseParentNode(e, o.getParentNode(), !0, r);
          }
        },
        ...
        removeTreeDom: function(e, t) {
          (t.isHover = !1),
            be.removeEditBtn(e, t),
            be.removeRemoveBtn(e, t),
            Ie.apply(e.view.removeHoverDom, [e.treeId, t]);
        },
        repairNodeLevelClass: function(e, t, o) {
          if (o !== t.level) {
            var d = Pe(t, e),
              r = Pe(t, he.id.A, e),
              n = Pe(t, he.id.UL, e),
      ...
      event: {},
      data: {
        setSonNodeLevel: function(e, t, o) {
          if (o) {
            var d = Re.nodeChildren(e, o);
            if (((o.level = t ? t.level + 1 : 0), d))
              for (var r = 0, n = d.length; r < n; r++) d[r] && Re.setSonNodeLevel(e, o, d[r]);
          }
        },
      },
    };
  ...
  Re.exSetting({
    ...
    Re.addInitCache(function(e) {}),
    Re.addInitNode(function(e, t, o, d, r, n, a) {
    ...
    Re.addInitProxy(function(e) {
      var t = e.target,
        ...
        l = null;
      if (
        (Ie.eqs(e.type, 'mouseover')
          ? (l = Ie.getMDom(o, t, [{ tagName: 'a', attrName: 'treeNode' + he.id.A }])) &&
            ((r = Ie.getNodeMainDom(l).id), (a = 'hoverOverNode'))
          : Ie.eqs(e.type, 'mouseout')
          ? (l = Ie.getMDom(o, d, [{ tagName: 'a', attrName: 'treeNode' + he.id.A }])) ||
            ((r = 'remove'), (a = 'hoverOutNode'))
          : Ie.eqs(e.type, 'mousedown') &&
            (l = Ie.getMDom(o, t, [{ tagName: 'a', attrName: 'treeNode' + he.id.A }])) &&
            ((r = Ie.getNodeMainDom(l).id), (a = 'mousedownNode')),
        0 < r.length)
      )
        switch (((n = Re.getNodeCache(o, r)), a)) {
          case 'mousedownNode':
            i = s.onMousedownNode;
            break;
          case 'hoverOverNode':
      ...
      return { stop: !1, node: n, nodeEventType: a, nodeEventCallback: i, treeEventType: '', treeEventCallback: null };
    }),
      ...
      (e.cancelEditName = function(e) {
        ...
        (e.copyNode = function(e, t, o, d) {
          ...
          if ((e || ((e = null), (o = he.move.TYPE_INNER)), o == he.move.TYPE_INNER)) {
            ...
            Ie.canAsync(this.setting, e) ? be.asyncNode(this.setting, e, d, i) : i();
        ...
        (e.editName = function(e) {
          e &&
            e.tId &&
            e === Re.getNodeCache(this.setting, e.tId) &&
            (e.parentTId && be.expandCollapseParentNode(this.setting, e.getParentNode(), !0),
            be.editNode(this.setting, e));
        }),
        (e.moveNode = function(e, t, o, d) {
          ...
          if (
            e &&
            ((t.parentTId == e.tId && o == he.move.TYPE_INNER) || 0 < Pe(t, this.setting).find('#' + e.tId).length)
          )
            return null;
          e = e || null;
          var n = this;
          ...
          return (
            Ie.canAsync(this.setting, e) && o === he.move.TYPE_INNER ? be.asyncNode(this.setting, e, d, a) : a(), t
          );
        }),
  ...
  be.cancelPreSelectedNode = function(e, t) {
    for (
      var o = Re.getRoot(e).curSelectedList, d = 0, r = o.length;
      d < r && ((t && t !== o[d]) || (be.removeTreeDom(e, o[d]), !t));
      d++
    );
  ...
  be.selectNode = function(e, t, o) {
    var d = Re.getRoot(e);
    return (
      (!Re.isSelectedNode(e, t) || d.curEditNode != t || !t.editNameFlag) &&
      (r && r.apply(be, arguments), be.addHoverDom(e, t), !0)
    );
  };
  var i = Ie.uCanDo;
  Ie.uCanDo = function(e, t) {
    ...
    return (
      !(
        !t ||
        !(
          Ie.eqs(t.type, 'mouseover') ||
          Ie.eqs(t.type, 'mouseout') ||
          Ie.eqs(t.type, 'mousedown') ||
          Ie.eqs(t.type, 'mouseup')
        )
      ) ||
      (o.curEditNode && ((be.editNodeBlur = !1), o.curEditInput.focus()),
      !o.curEditNode && (!i || i.apply(be, arguments)))
    );
  };
})(jQuery);
