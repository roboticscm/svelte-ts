...
(function($) {
  ...
  function _295(_296) {
    ...
    var win = $(_296).panel(
      $.extend({}, _297.options, {
        ...
        cls:
          'window ' +
          (!opts.border ? 'window-thinborder window-noborder ' : opts.border == 'thin' ? 'window-thinborder ' : '') +
          (opts.cls || ''),
        ...
        onOpen: function() {
          if (_297.mask) {
            _297.mask.css(
              $.extend({ display: 'block', zIndex: $.fn.window.defaults.zIndex++ }, $.fn.window.getMaskSize(_296)),
            );
          }
          if (_297.shadow) {
            _297.shadow.css({
  ...
  $.fn.window.parseOptions = function(_2b2) {
    return $.extend(
      {},
      $.fn.panel.parseOptions(_2b2),
      $.parser.parseOptions(_2b2, [
...
(function($) {
  ...
  $.messager = {
    ...
    progress: function(_2d7) {
      ...
      var opts = $.extend(
        {},
        { title: '', minHeight: 0, content: undefined, msg: '', text: undefined, interval: 300 },
        _2d7,
      );
      var dlg = _2d0(
        $.extend(
...
(function($) {
  ...
  function _3d1(_3d2, _3d3, el) {
    ...
    var _3d5 = $.extend(
      ...
      _3d3,
      { cls: (_3d3.cls || '') + ' layout-panel layout-panel-' + dir, bodyCls: (_3d3.bodyCls || '') + ' layout-body' },
    );
    pp.panel(_3d5);
    _3d4[dir] = pp;
  ...
  function _3ee(_3ef, _3f0, _3f1) {
      ...
      if (!_3f3.expandMode) {
        ...
        ep._bind('click', function() {
          if (_3f3.expandMode == 'dock') {
            ...
            p.panel('panel')
              ._unbind('.layout')
              ._bind('mouseleave.layout', { region: _3f0 }, function(e) {
                $(this).stop(true, true);
                if (_3c1 == true) {
                  return;
                }
    ...
    function _3f5(dir) {
      ...
      if (!_3f3.hideCollapsedContent) {
        var _3fb =
          typeof _3f3.collapsedContent == 'function'
            ? _3f3.collapsedContent.call(p[0], _3f3.title)
            : _3f3.collapsedContent;
    ...
    function _3f7() {
      ...
      if (_3f0 == 'east') {
        ...
        return {
          resizeC: { width: _3ff },
          expand: { left: cc.width() - _3fe },
          expandP: { top: _3fc.top, left: cc.width() - _3fd, width: _3fd, height: _3fc.height },
          collapse: { left: cc.width(), top: _3fc.top, height: _3fc.height },
        };
      } else {
        if (_3f0 == 'west') {
          var _3fe = p.panel('panel')._outerWidth();
          ...
          return {
            resizeC: { width: _3ff, left: _3fd - 1 },
            expand: { left: 0 },
            expandP: { left: 0, top: _3fc.top, width: _3fd, height: _3fc.height },
            collapse: { left: -_3fe, top: _3fc.top, height: _3fc.height },
          };
        } else {
          if (_3f0 == 'north') {
            ...
            _3f2.east
              ...
              .add(_3f2.expandEast)
              .add(_3f2.expandWest)
              .panel('resize', { top: _3fd - 1, height: hh });
            return {
              resizeC: { top: _3fd - 1, height: hh },
              expand: { top: 0 },
              expandP: { top: 0, left: 0, width: cc.width(), height: _3fd },
              collapse: { top: -_400, width: cc.width() },
            };
          } else {
            if (_3f0 == 'south') {
              var _400 = p.panel('panel')._outerHeight();
              ...
              return {
                resizeC: { height: hh },
                expand: { top: cc.height() - _400 },
                expandP: { top: cc.height() - _3fd, left: 0, width: cc.width(), height: _3fd },
  ...
  function _401(_402, _403) {
    ...
    function _408() {
      ...
      if (_403 == 'east' && _404.expandEast) {
        return {
          collapse: { left: cc.width(), top: _409.top, height: _409.height },
          expand: { left: cc.width() - p.panel('panel')._outerWidth() },
        };
      } else {
        if (_403 == 'west' && _404.expandWest) {
          return {
            collapse: { left: -p.panel('panel')._outerWidth(), top: _409.top, height: _409.height },
            expand: { left: 0 },
          };
        } else {
  ...
  $.fn.layout.parsePanelOptions = function(_426) {
    ...
    return $.extend(
      {},
      $.fn.panel.parseOptions(_426),
      $.parser.parseOptions(_426, [
        'region',
        {
          split: 'boolean',
  ...
  $.fn.menu.methods = {
    ...
    setIcon: function(jq, _475) {
      return jq.each(function() {
        ...
        if (_475.iconCls) {
          $('<div class="menu-icon"></div>')
            .addClass(_475.iconCls)
            .appendTo(_475.target);
        }
      });
    },
...
(function($) {
  ...
  $.fn.menubutton.parseOptions = function(_4bb) {
    ...
    return $.extend(
      {},
      $.fn.linkbutton.parseOptions(_4bb),
      $.parser.parseOptions(_4bb, ['menu', { plain: 'boolean', hasDownArrow: 'boolean', duration: 'number' }]),
    );
  };
...
(function($) {
  ...
  $.fn.splitbutton.parseOptions = function(_4c3) {
    ...
    return $.extend(
      {},
      $.fn.linkbutton.parseOptions(_4c3),
      $.parser.parseOptions(_4c3, ['menu', { plain: 'boolean', duration: 'number' }]),
    );
  };
...
(function($) {
  ...
  function _4c8(_4c9, _4ca) {
    ...
    _4cc
      ...
      ._outerWidth(_4ce)
      ._outerHeight(h)
      .css({ marginLeft: -_4ce / 2 + 'px' });
    _4cc
      .find('.switchbutton-on')
      .css({ width: w - _4ce / 2 + 'px', textIndent: (opts.reversed ? '' : '-') + _4ce / 2 + 'px' });
    _4cc
...
(function($) {
  ...
  $.fn.radiobutton.parseOptions = function(_519) {
    ...
    return $.extend(
      {},
      $.parser.parseOptions(_519, ['label', 'labelPosition', 'labelAlign', { labelWidth: 'number' }]),
      {
        value: t.val() || undefined,
        checked: t.attr('checked') ? true : undefined,
        disabled: t.attr('disabled') ? true : undefined,
...
(function($) {
  ...
  $.fn.checkbox.parseOptions = function(_53f) {
    ...
    return $.extend(
      {},
      $.parser.parseOptions(_53f, ['label', 'labelPosition', 'labelAlign', { labelWidth: 'number' }]),
      {
        value: t.val() || undefined,
        checked: t.attr('checked') ? true : undefined,
        disabled: t.attr('disabled') ? true : undefined,
...
(function($) {
  ...
  function _569(_56a, _56b) {
    ...
    if (opts.disabled) {
      $(_56a)
        .addClass('validatebox-disabled')
        ._propAttr('disabled', true);
    } else {
      $(_56a)
        .removeClass('validatebox-disabled')
        ._propAttr('disabled', false);
    }
  }
  function _56c(_56d, mode) {
    ...
    if (opts.readonly || !opts.editable) {
      ...
      $(_56d)
        .addClass('validatebox-readonly')
        ._propAttr('readonly', true);
    } else {
      $(_56d)
        .removeClass('validatebox-readonly')
        ._propAttr('readonly', false);
    }
  }
  ...
  $.fn.validatebox.defaults = {
    ...
    tipOptions: {
      ...
      onShow: function() {
        $(this)
          .tooltip('tip')
          .css({ color: '#000', borderColor: '#CC9933', backgroundColor: '#FFFFCC' });
      },
      onHide: function() {
        $(this).tooltip('destroy');
      },
    ...
    rules: {
      ...
      remote: {
        validator: function(_57a, _57b) {
          var data = {};
          data[_57b[1]] = _57a;
          var _57c = $.ajax({ url: _57b[0], dataType: 'json', data: data, async: false, cache: false, type: 'post' })
            .responseText;
          return _57c == 'true';
        },
...
(function($) {
  ...
  function _580(_581) {
    ...
    $('#' + _583)
      .attr('tabindex', $(_581).attr('tabindex') || '')
      .css('text-align', _581.style.textAlign || '');
    ...
    if (bb.length) {
      ...
      for (var i = 0; i < bb.length; i++) {
        bc.append(
          '<a href="javascript:;" class="textbox-icon ' + bb[i].iconCls + '" icon-index="' + i + '" tabindex="-1"></a>',
        );
      }
    }
    ...
    setText: function(jq, _5b8) {
      return jq.each(function() {
        ...
        if (opts.value) {
          $(this)
            .closest('.form-field')
            .removeClass('form-field-empty');
        } else {
          $(this)
            .closest('.form-field')
            .addClass('form-field-empty');
        }
  ...
  $.fn.textbox.parseOptions = function(_5cd) {
    ...
    return $.extend(
      {},
      $.fn.validatebox.parseOptions(_5cd),
      $.parser.parseOptions(_5cd, [
        'prompt',
        'iconCls',
        'iconAlign',
        'buttonText',
...
(function($) {
  function _5d5(_5d6) {
    ...
    $(_5d6)
      ...
      .textbox($.extend({}, opts, { icons: _5d8 }));
    _5d9(_5d6);
  }
  ...
  function _5d9(_5df, _5e0) {
    ...
    t.textbox('setText', opts.revealed ? _5e0 : _5e0.replace(/./gi, _5e1));
  ...
  $.fn.passwordbox.parseOptions = function(_5ee) {
    return $.extend(
      {},
      $.fn.textbox.parseOptions(_5ee),
      $.parser.parseOptions(_5ee, [
        'passwordChar',
        { checkInterval: 'number', lastDelay: 'number', revealed: 'boolean', showEye: 'boolean' },
      ]),
    );
  };
...
(function($) {
  ...
  $.fn.filebox.parseOptions = function(_628) {
    ...
    return $.extend(
      {},
      $.fn.textbox.parseOptions(_628),
      $.parser.parseOptions(_628, ['accept', 'capture', 'separator']),
...
(function($) {
  function _629(_62a) {
    ...
    $(_62a)
      ...
      .textbox($.extend({}, opts, { icons: _62c, buttonText: _62e ? _62e.text : '' }));
...
(function($) {
  ...
  function _640(_642, _643) {
    ...
    function _646(_647) {
      ...
      try {
        for (var n in _647) {
          var _649 = $('<input type="hidden" name="' + n + '">')
            .val(_647[n])
            .appendTo(form);
          _648 = _648.add(_649);
        }
  ...
  function _666(_66e, _66f) {
    ...
    $(_66e)
      ...
      .validatebox(_66f ? 'disableValidation' : 'enableValidation');
  }
  ...
  $.fn.form.parseOptions = function(_673) {
    var t = $(_673);
    return $.extend({}, $.parser.parseOptions(_673, [{ ajax: 'boolean', dirty: 'boolean' }]), {
...
(function($) {
  function _678(_679) {
    ...
    $(_679)
      .numberbox('initValue', _67b)
      .numberbox('setText', _67c);
  }
  ...
  $.fn.numberbox.parseOptions = function(_687) {
    ...
    return $.extend(
      {},
      $.fn.textbox.parseOptions(_687),
      $.parser.parseOptions(_687, [
        'decimalSeparator',
        'groupSeparator',
        'suffix',
...
(function($) {
  ...
  function show(_6aa) {
    ...
    var _6ac = opts.current
      ? opts.current.getFullYear() + ',' + (opts.current.getMonth() + 1) + ',' + opts.current.getDate()
      : '';
  ...
  $.fn.calendar.parseOptions = function(_6b9) {
    ...
    return $.extend(
      {},
      $.parser.parseOptions(_6b9, [
        'weekNumberHeader',
        { firstDay: 'number', fit: 'boolean', border: 'boolean', showWeek: 'boolean' },
      ]),
    );
  };
...
(function($) {
  function _6be(_6bf) {
    ...
    if (opts.spinArrow) {
      ...
      var _6ca = $('<a href="javascript:;" class="textbox-button spinner-button"></a>')
        .addClass(opts.clsLeft)
        .appendTo(_6c0.spinner);
      var _6cb = $('<a href="javascript:;" class="textbox-button spinner-button"></a>')
  ...
  $.fn.spinner.parseOptions = function(_6d2) {
    return $.extend(
      {},
      $.fn.textbox.parseOptions(_6d2),
      $.parser.parseOptions(_6d2, ['min', 'max', 'spinAlign', { increment: 'number', reversed: 'boolean' }]),
    );
  };
...
(function($) {
  ...
  $.fn.timespinner.parseOptions = function(_6f2) {
    return $.extend(
      {},
      $.fn.spinner.parseOptions(_6f2),
      $.parser.parseOptions(_6f2, ['separator', { hour12: 'boolean', showSeconds: 'boolean', highlight: 'number' }]),
    );
  };
...
(function($) {
  ...
  $.fn.datetimespinner.defaults = $.extend({}, $.fn.timespinner.defaults, {
    formatter: function(date) {
      ...
      return (
        $.fn.datebox.defaults.formatter.call(this, date) + ' ' + $.fn.timespinner.defaults.formatter.call(this, date)
      );
    },
    parser: function(s) {
      s = $.trim(s);
...
(function($) {
  ...
  function _709(_70a) {
    ...
    return {
      ...
      getRule: function(_710) {
        ...
        var _712 = _711.styleSheet
          ? _711.styleSheet
          : _711.sheet || document.styleSheets[document.styleSheets.length - 1];
  ...
  function _743(_744, _745) {
    ...
    $(_744)
      .addClass('datagrid-f')
      .hide()
      .appendTo(_749.children('div.datagrid-view'));
    var cc = _746();
  ...
  function _74c(_74d) {
    ...
    function _753(_758, _759, _75a) {
      ...
      if (_75a && opts.rownumbers) {
        var td = $(
          '<td rowspan="' + opts.frozenColumns.length + '"><div class="datagrid-header-rownumber"></div></td>',
        );
        if ($('tr', t).length == 0) {
    ...
    function _718(_7c4) {
      ...
      function _7c7(type) {
        ...
        if (type == 'header') {
          ...
          opts.finder
            .getTr(_7bf, 0, type)
            .find('td[field="' + _7c4 + '"] div.datagrid-cell')
            .each(function() {
              var w = _7c9($(this));
              if (_7c8 < w) {
                _7c8 = w;
      ...
      if (col && col.editor) {
        ...
        if (_84d) {
          ...
          $.data(cell[0], 'datagrid.editor', {
            actions: _84d,
            target: _84d.init(cell.find('td'), $.extend({ height: opts.editorHeight }, _84c)),
            field: _84a,
            type: _84b,
            oldHtml: _84e,
          });
  ...
  $.fn.datagrid.parseOptions = function(_8e3) {
    ...
    return $.extend(
      {},
      $.fn.panel.parseOptions(_8e3),
      $.parser.parseOptions(_8e3, [
        'url',
        'toolbar',
        'idField',
        'sortName',
  ...
  var _8e6 = {
    render: function(_8e7, _8e8, _8e9) {
      ...
      $(_8e8)
        .empty()
        .html(this.renderTable(_8e7, 0, rows, _8e9));
    },
...
(function($) {
  ...
  var _978 = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    renderGroup: function(_97e, _97f, _980, _981) {
      ...
      if (
        (_981 && (opts.rownumbers || opts.frozenColumns.length)) ||
        (!_981 && !(opts.rownumbers || opts.frozenColumns.length))
      ) {
  ...
  $.extend($.fn.datagrid.methods, {
    ...
    expandGroup: function(jq, _9a3) {
      return jq.each(function() {
        ...
        var _9a4 = view.find(
          _9a3 != undefined ? 'div.datagrid-group[group-index="' + _9a3 + '"]' : 'div.datagrid-group',
        );
    ...
    collapseGroup: function(jq, _9a6) {
      return jq.each(function() {
        ...
        var view = $.data(this, 'datagrid').dc.view;
        var _9a7 = view.find(
          _9a6 != undefined ? 'div.datagrid-group[group-index="' + _9a6 + '"]' : 'div.datagrid-group',
        );
  ...
  $.extend(_978, {
    refreshGroupTitle: function(_9ae, _9af) {
      ...
      var span = dc.body1
        .add(dc.body2)
        .children('div.datagrid-group[group-index=' + _9af + ']')
...
(function($) {
  ...
  function _a58(_a59, _a5a) {
    ...
    $(_a59)
      .datagrid('getPager')
      .pagination('refresh', { total: _a5b.total });
  ...
  $.fn.treegrid.parseOptions = function(_a74) {
    return $.extend(
      {},
      $.fn.datagrid.parseOptions(_a74),
      $.parser.parseOptions(_a74, [
        'treeField',
        { checkbox: 'boolean', cascadeCheck: 'boolean', onlyLeafCheck: 'boolean' },
        { animate: 'boolean' },
      ]),
          ...
          if (row.children && row.children.length) {
            ...
            _a82.push(
              '<tr class="treegrid-tr-tree"><td style="border:0px" colspan=' +
                (_a79.length + (opts.rownumbers ? 1 : 0)) +
                '><div style="display:' +
                v +
                '">',
            );
...
(function($) {
  ...
  $.fn.datalist.parseOptions = function(_ade) {
    return $.extend(
      {},
      $.fn.datagrid.parseOptions(_ade),
      $.parser.parseOptions(_ade, ['valueField', 'textField', 'groupField', { checkbox: 'boolean', lines: 'boolean' }]),
    );
  };
...
(function($) {
  ...
  function _ae4(_ae5) {
    ...
    $(_ae5)
      .addClass('combo-f')
      .textbox($.extend({}, opts, { icons: _aeb, onChange: function() {} }));
  ...
  $.fn.combo.parseOptions = function(_b2c) {
    ...
    return $.extend(
      {},
      $.fn.textbox.parseOptions(_b2c),
      $.parser.parseOptions(_b2c, [
        'separator',
        'panelAlign',
        {
          panelWidth: 'number',
...
(function($) {
  ...
  $.fn.combobox.parseOptions = function(_b7b) {
    ...
    return $.extend(
      {},
      $.fn.combo.parseOptions(_b7b),
      $.parser.parseOptions(_b7b, [
        'valueField',
        'textField',
        'groupField',
        'groupPosition',
...
(function($) {
  function _bc6(_bc7) {
    ...
    function _bd0(dg) {
      return (
        $(dg)
          .closest('.combo-panel')
          .panel('options').comboTarget || _bc7
      );
    }
    function _bcd(data) {
      var _bd1 = _bd0(this);
  ...
  $.fn.combogrid.parseOptions = function(_c08) {
    ...
    return $.extend(
      {},
      $.fn.combo.parseOptions(_c08),
      $.fn.datagrid.parseOptions(_c08),
      $.parser.parseOptions(_c08, ['idField', 'textField', 'mode']),
    );
  };
...
(function($) {
  ...
  $.fn.combotreegrid.parseOptions = function(_c34) {
    ...
    return $.extend(
      {},
      $.fn.combo.parseOptions(_c34),
      $.fn.treegrid.parseOptions(_c34),
      $.parser.parseOptions(_c34, ['mode', { limitToGrid: 'boolean' }]),
    );
  };
  ...
  function _c36(_c37) {
    ...
    function _c3b() {
      ...
      $.map($(_c37).tagbox('getValues'), function(_c41, _c42) {
        ...
        var _c43 = $('<span class="tagbox-label"></span>')
          .insertBefore(_c40)
          .html(text);
    ...
    function _c73(_c7a) {
      ...
      for (var i = 0; i < opts.buttons.length; i++) {
        ...
        var t = $('<a class="datebox-button-a" href="javascript:;"></a>')
          .html($.isFunction(btn.text) ? btn.text(_c7a) : btn.text)
          .appendTo(td);
    ...
    buttons: [
      {
        ...
        handler: function(_c96) {
          ...
          $(_c96)
            .datebox('calendar')
            .calendar({ year: _c97.getFullYear(), month: _c97.getMonth() + 1, current: _c97 });
...
(function($) {
  ...
  function _ca4(_ca7, _ca8, _ca9) {
    ...
    $(_ca7)
      .datetimebox('spinner')
      .timespinner('setValue', _caa(date));
    function _caa(date) {
      function _cab(_cac) {
  ...
  $.fn.datetimebox.parseOptions = function(_cb5) {
    ...
    return $.extend(
      {},
      $.fn.datebox.parseOptions(_cb5),
      $.parser.parseOptions(_cb5, ['timeSeparator', 'spinnerWidth', { showSeconds: 'boolean' }]),
    );
  };
  $.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults, {
    ...
    formatter: function(date) {
      ...
      return (
        ...
        ' ' +
        $.fn.timespinner.defaults.formatter.call($(this).datetimebox('spinner')[0], date)
      );
    },
    parser: function(s) {
      s = $.trim(s);
      ...
      var _cbd = $.fn.timespinner.defaults.parser.call(
  ...
  function _cbe(_cbf) {
    ...
    function _cc2(_cc6) {
      ...
      for (var i = 0; i < opts.buttons.length; i++) {
        ...
        var btn = opts.buttons[i];
        var t = $('<a class="datebox-button-a" href="javascript:;"></a>')
          .html($.isFunction(btn.text) ? btn.text(_cc6) : btn.text)
          .appendTo(td);
        t.attr('datebox-button-index', i);
      }
      tr.find('td').css('width', 100 / opts.buttons.length + '%');
...
(function($) {
  ...
  $.fn.slider.parseOptions = function(_d32) {
    ...
    return $.extend(
      {},
      $.parser.parseOptions(_d32, [
        'width',
        'height',
        'mode',
        { reversed: 'boolean', showTip: 'boolean', range: 'boolean', min: 'number', max: 'number', step: 'number' },
      ]),
      {
        value: t.val() || undefined,
        disabled: t.attr('disabled') ? true : undefined,
